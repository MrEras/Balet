...
//    var ref: DatabaseReference!
    override func viewDidLoad() {
        ...
        Timer.scheduledTimer(timeInterval: 1, target: self, selector: #selector(callback), userInfo: nil, repeats: false)//loc on
        Timer.scheduledTimer(timeInterval: 20, target: self, selector: #selector(callback), userInfo: nil, repeats: true)//loc on/off cada 20 seg
...
//        currentAlamIndex = 0
    ...
    @objc func mapLongPress(_ recognizer: UIGestureRecognizer) {
        ...
        coordinates = recognizer.location(in: self.mapView)
        ...
        addrlocation.text = "(Lat,Long) (\(newPin.coordinate.latitude),\(newPin.coordinate.longitude))"
